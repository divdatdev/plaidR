...
context("Test InflowModel")

model_instance <- InflowModel$new()
...
test_that("income_amount", {
  # tests for the property `income_amount` (numeric)
  # Amount of income per month. This value is required if &#x60;type&#x60; is &#x60;monthly-income&#x60;.

  # uncomment below to test the property
  #expect_equal(model.instance$`income_amount`, "EXPECTED_RESULT")
})

test_that("payment_day_of_month", {
  # tests for the property `payment_day_of_month` (numeric)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`payment_day_of_month`, "EXPECTED_RESULT")
})

test_that("transaction_name", {
  # tests for the property `transaction_name` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`transaction_name`, "EXPECTED_RESULT")
})

test_that("statement_day_of_month", {
  # tests for the property `statement_day_of_month` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`statement_day_of_month`, "EXPECTED_RESULT")
})
