...
context("Test InvestmentsHoldingsGetRequest")

model_instance <- InvestmentsHoldingsGetRequest$new()
...
test_that("options", {
  # tests for the property `options` (InvestmentHoldingsGetRequestOptions)
