...
context("Test PaymentInitiationPaymentCreateResponse")

model_instance <- PaymentInitiationPaymentCreateResponse$new()
...
test_that("status", {
  # tests for the property `status` (PaymentInitiationPaymentCreateStatus)
