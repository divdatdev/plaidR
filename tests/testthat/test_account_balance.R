...
context("Test AccountBalance")

model_instance <- AccountBalance$new()
...
test_that("last_updated_datetime", {
  # tests for the property `last_updated_datetime` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`last_updated_datetime`, "EXPECTED_RESULT")
})
