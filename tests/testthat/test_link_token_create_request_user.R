...
context("Test LinkTokenCreateRequestUser")

model_instance <- LinkTokenCreateRequestUser$new()
...
test_that("phone_number_verified_time", {
  # tests for the property `phone_number_verified_time` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`phone_number_verified_time`, "EXPECTED_RESULT")
})
...
test_that("email_address_verified_time", {
  # tests for the property `email_address_verified_time` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`email_address_verified_time`, "EXPECTED_RESULT")
})
