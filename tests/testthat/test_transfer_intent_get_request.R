...
context("Test TransferIntentGetRequest")

model_instance <- TransferIntentGetRequest$new()
...
test_that("transfer_intent_id", {
  # tests for the property `transfer_intent_id` (character)
  # Plaid&#39;s unique identifier for a transfer intent object.

  # uncomment below to test the property
  #expect_equal(model.instance$`transfer_intent_id`, "EXPECTED_RESULT")
})
