...
context("Test TransferEventListRequest")

model_instance <- TransferEventListRequest$new()
...
test_that("transfer_type", {
  # tests for the property `transfer_type` (TransferEventListTransferType)
...
test_that("event_types", {
  # tests for the property `event_types` (array[TransferEventType])
