...
context("Test TransferAuthorizationCreateRequest")

model_instance <- TransferAuthorizationCreateRequest$new()
...
test_that("device", {
  # tests for the property `device` (TransferAuthorizationDevice)
