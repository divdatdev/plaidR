...
context("Test UserCustomPassword")

model_instance <- UserCustomPassword$new()
...
test_that("seed", {
  # tests for the property `seed` (character)
...
test_that("override_accounts", {
  # tests for the property `override_accounts` (array[OverrideAccounts])
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`override_accounts`, "EXPECTED_RESULT")
})

test_that("mfa", {
  # tests for the property `mfa` (MFA)

  # uncomment below to test the property
  #expect_equal(model.instance$`mfa`, "EXPECTED_RESULT")
})

test_that("recaptcha", {
  # tests for the property `recaptcha` (character)
  # You may trigger a reCAPTCHA in Plaid Link in the Sandbox environment by using the recaptcha field. Possible values are &#x60;good&#x60; or &#x60;bad&#x60;. A value of &#x60;good&#x60; will result in successful Item creation and &#x60;bad&#x60; will result in a &#x60;RECAPTCHA_BAD&#x60; error to simulate a failed reCAPTCHA. Both values require the reCAPTCHA to be manually solved within Plaid Link.

  # uncomment below to test the property
  #expect_equal(model.instance$`recaptcha`, "EXPECTED_RESULT")
})

test_that("force_error", {
  # tests for the property `force_error` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`force_error`, "EXPECTED_RESULT")
})
