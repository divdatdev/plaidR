...
context("Test AccountsBalanceGetRequestOptions")

model_instance <- AccountsBalanceGetRequestOptions$new()
...
test_that("min_last_updated_datetime", {
  # tests for the property `min_last_updated_datetime` (character)
  ...
  # uncomment below to test the property
  #expect_equal(model.instance$`min_last_updated_datetime`, "EXPECTED_RESULT")
})
