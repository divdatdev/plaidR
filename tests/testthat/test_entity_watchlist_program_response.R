...
context("Test EntityWatchlistProgramResponse")

model_instance <- EntityWatchlistProgramResponse$new()
...
test_that("lists_enabled", {
  # tests for the property `lists_enabled` (set[EntityWatchlistCode])
