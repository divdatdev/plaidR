...
context("Test CreditBankIncomeRefreshRequest")

model_instance <- CreditBankIncomeRefreshRequest$new()
...
test_that("options", {
  # tests for the property `options` (CreditBankIncomeRefreshRequestOptions)
