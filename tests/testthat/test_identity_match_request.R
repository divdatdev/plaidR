...
context("Test IdentityMatchRequest")

model_instance <- IdentityMatchRequest$new()
...
test_that("user", {
  # tests for the property `user` (IdentityMatchUser)
...
test_that("options", {
  # tests for the property `options` (IdentityMatchRequestOptions)
