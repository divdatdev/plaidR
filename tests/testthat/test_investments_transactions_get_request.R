...
context("Test InvestmentsTransactionsGetRequest")

model_instance <- InvestmentsTransactionsGetRequest$new()
...
test_that("options", {
  # tests for the property `options` (InvestmentsTransactionsGetRequestOptions)
