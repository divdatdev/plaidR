...
context("Test WatchlistScreeningCreateRequest")

model_instance <- WatchlistScreeningCreateRequest$new()

test_that("search_terms", {
  # tests for the property `search_terms` (WatchlistScreeningRequestSearchTerms)
