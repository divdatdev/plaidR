...
context("Test WebhookUpdateAcknowledgedWebhook")

model_instance <- WebhookUpdateAcknowledgedWebhook$new()
...
test_that("new_webhook_url", {
  # tests for the property `new_webhook_url` (character)
  # The new webhook URL

  # uncomment below to test the property
  #expect_equal(model.instance$`new_webhook_url`, "EXPECTED_RESULT")
})
