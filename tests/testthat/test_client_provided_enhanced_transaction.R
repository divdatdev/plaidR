...
context("Test ClientProvidedEnhancedTransaction")

model_instance <- ClientProvidedEnhancedTransaction$new()
...
test_that("enhancements", {
  # tests for the property `enhancements` (Enhancements)

  # uncomment below to test the property
  #expect_equal(model.instance$`enhancements`, "EXPECTED_RESULT")
})
