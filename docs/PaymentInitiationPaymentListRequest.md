# plaidr::PaymentInitiationPaymentListRequest
...
**cursor** | **character** | A string in RFC 3339 format (i.e. \&quot;2019-12-06T22:35:49Z\&quot;). Only payments created before the cursor will be returned. | [optional] 
**consent_id** | **character** | The consent ID. If specified, only payments, executed using this consent, will be returned. | [optional] 
